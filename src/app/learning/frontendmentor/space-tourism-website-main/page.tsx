...
export default function HomePage() {
  return (
    <div
      className={`${bellefair.className} h-screen w-screen bg-space-home-mobile`}
    >
      <div className="flex flex-col justify-center items-center">
        <div className="flex w-full justify-between items-center p-[24px] md:p-0 md:ml-[39px] lgs:mt-[40px] lgs:ml-[55px] overflow-visible">
          <Image src={logo} alt="logo" width={40} height={40} />

          <div className="hidden lgs:block w-[473px] border-[0.5px] mr-[-200px] z-10"></div>

          <div className="h-[24px] w-[21px] md:h-[96px] md:w-[450px] flex md:justify-center md:items-center lgs:w-[830px]">
            <Image
              className="md:hidden"
              src={hamburger}
              alt="hamburger menu"
        ...
        <div className="flex flex-col justify-center items-center lgs:flex-row lgs:mt-[251px] lgs:items-end lgs:justify-between lgs:bg-red-200 lgs:w-full lgs:px-[165px]">
          <div className="flex flex-col justify-between h-[276px] w-[327px] mt-[24px] md:w-[450px] md:h-[334px] md:mt-[106px] lgs:h-[382px] lgs:m-0 text-center lg:text-start text-white">
            ...
            <p
              className={`${barlowRegular.className} text-[15px]/[25px] md:text-[16px]/[28px] lgs:text-[18px]/[32px] text-space-violet`}
            >
